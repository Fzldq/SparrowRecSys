...
repeated_candidate_emb_layer = tf.keras.layers.RepeatVector(RECENT_MOVIES)(
    candidate_emb_layer)
...
activation_all = tf.keras.layers.concatenate(
    [activation_sub_layer, user_behaviors_emb_layer,
...
activation_unit = tf.keras.layers.Dense(1, activation='sigmoid')(
    activation_unit)
...
concat_layer = tf.keras.layers.concatenate(
    [user_profile_layer, user_behaviors_pooled_layers,
